  ...
  return (
    <section className="p-10 py-40 md:p-40">
      <form action="" method="" onSubmit={(e) => handleSubmit(e)}>
        <h1 className="font-bold text-3xl md:text-5xl">Redesenhar o mundo</h1>
        <div className="bg-black text-white pt-20 pb-4 flex flex-col justify-center">
          <div className="w-full">
            <div className="">
              <div className="flex flex-col md:flex-row gap-6 w-full">
                <div className="flex-1 my-4">
                  <label htmlFor="name" className="block text-md md:text-xl mb-2">
                    Nome
                  </label>
                  <input
                    type="text"
                ...
                <div className="flex-1 my-4">
                  <label htmlFor="email" className="block text-md md:text-xl mb-2">
                    Email
                  </label>
                  <input
                    type="email"
                ...
                <div className="flex-1 my-4">
                  <label htmlFor="contact" className="block text-md md:text-xl mb-2">
                    Contacto (opcional)
                  </label>
                  <input
                    type="text"
              ...
              <div className="my-4">
                <label htmlFor="message" className="block text-md md:text-xl mb-2">
                  Mensagem
                </label>
                <textarea
                  id="message"
