...
export const loader: LoaderFunction = async ({ params }) => {
  ...
  const res = await fetch(
    `${pocketBaseUrl}/api/collections/Produtos/records?perPage=500&sort=order,id&expand=design,subcategory,materiais,materiais_disponiveis,ral_disponiveis,acabamentos_recomendado,subcategory.category&slug~"${productSlug}"`
  );
